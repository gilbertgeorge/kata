...
function pushRange(range, rangeStart, rangeEnd) {
...
function solution(list){
    ...
    for (let i = 1; i < list.length; i++) {
        if (list[i] === rangeEnd + 1) {
            ...
            pushRange(range, rangeStart, rangeEnd);
            rangeStart = list[i];
            rangeEnd = list[i];
        }
    }
...
console.log(solution([-10, -9, -8, -6, -3, -2, -1, 0, 1, 3, 4, 5, 7, 8, 9, 10, 11, 14, 15, 17, 18, 19, 20, 22, 23])); // "-10--8,-6,-3-1,3-5,7-11,14,15,17-20,22,23"